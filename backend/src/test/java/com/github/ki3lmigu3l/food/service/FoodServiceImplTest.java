...
class FoodServiceImplTest {
    ...
    void shouldReturnFoodWhenSearchByIdWithValidId() {
        Food food = new Food(1L, "Pizza", "image.url", "description" ,new BigDecimal("49.90"));
    ...
    void shouldCreateFoodWhenValidDataIsProvided() {
        FoodRequest request = new FoodRequest("Sushi", "image.sushi", "description" ,new BigDecimal("60.0"));
        Food savedFood = new Food(1L, request.name(), request.image(), request.description(),request.price());
    ...
    void shouldUpdateFoodWhenExistingIdAndValidDataAreProvided() {
        Long id = 1L;
        Food existing = new Food(id, "oldName", "old.image", "description" ,new BigDecimal("10.00"));
        FoodRequest request = new FoodRequest("newName", "new.image", "description" ,new BigDecimal("15.00"));
    ...
    void shouldDeleteFoodWhenValidIdIsProvided() {
        Long id = 1L;
        Food existing = new Food(id, "Taco", "taco.image","description" , new BigDecimal("20.00"));
