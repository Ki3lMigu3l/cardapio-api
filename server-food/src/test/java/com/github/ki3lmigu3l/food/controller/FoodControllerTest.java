...
class FoodControllerTest {
    ...
    void shouldReturnFoodByIdWhenFound() throws Exception {
        var food = new Food(1L, "Pizza", "img1", new BigDecimal("50.00"));
    ...
    void shouldCreateFood() throws Exception {
        var request = new FoodRequest("Sushi", "img.sushi", new BigDecimal("60.0"));
        var created = new Food(1L, request.name(), request.image(), request.price());
    ...
    void shouldUpdateFoodWhenExists() throws Exception {
        var request = new FoodRequest("NewName", "new.img", new BigDecimal("70.00"));
        var updated = new Food(1L, request.name(), request.image(), request.price());
    ...
    void shouldReturnNotFoundWhenUpdatingNonExistentFood() throws Exception {
        var request = new FoodRequest("X", "x.img", new BigDecimal("10.00"));
